...
export default class Dashboard extends Component {
  ...
  getProduct = () => {
    ...
    axios.get(`http://localhost:8080/get-product${data}`, {
      headers: {
  ...
  addProduct = () => {
    ...
    axios.post('http://localhost:8080/add-product', file, {
      headers: {
  ...
  updateProduct = () => {
    ...
    axios.post('http://localhost:8080/update-product', file, {
      headers: {
        'content-type': 'multipart/form-data',
        'token': this.state.token
      }
            ...
            <TableBody>
              {this.state.products.map((row) => (
                <TableRow key={row.name}>
                  ...
                  <TableCell align="center"><img src={`http://localhost:8080/${row.image}`} width="70" height="70" /></TableCell>
